 ...
 */
async function executePythonScript(scriptContent) {
    try {
 ...
 * 等待 GLB 文件生成
 */
async function waitForGlb(glbPath, timeoutMs = 60000) {
...
export function registerExecuteBlenderScript(server) {
    server.registerTool("q3d_execute_blender_script", "通过 Blender Bridge 执行 Blender Python 脚本，生成 3D 模型 GLB 文件。" +
                    ...
                    content: [
                        {
                            ...
                            text: JSON.stringify({
                                ...
                                error: {
                                    ...
                                    suggestion: "请检查脚本语法是否正确，或查看 Blender 控制台错误信息。\n" +
                    ...
                    content: [
                        {
                            ...
                            text: JSON.stringify({
                                ...
                                error: {
                                    ...
                                    suggestion: "脚本可能执行成功但未导出 GLB，请检查脚本中是否包含 export_glb() 调用。\n" +
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            message: "3D 模型生成成功！下一步：调用 q3d_assess_model 评估模型质量，或调用 q3d_refine_blender_script 根据反馈优化。",
...
//# sourceMappingURL=execute-blender-script.js.map
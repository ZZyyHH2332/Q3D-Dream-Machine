...
export function registerGenerate3DModel(server: any): void {
  server.registerTool(
    "q3d_generate_3d_model",
    "将 Q 版形象图转换为 3D GLB 模型（支持 Hunyuan3D / 302.AI / Tripo3D 自动切换）",
    {
      avatarPath: {
        type: "string",
        description:
          "Q 版形象图片路径（可选，默认使用最近生成的 avatar.png）",
      },
      sessionId: {
        type: "string",

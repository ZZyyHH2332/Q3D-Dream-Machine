...
const MOCK_STYLE_PROMPTS = {
    ...
    simple: "转换为简约卡通风格，极简几何感，色块平涂无复杂纹理。默认配色：黑白灰加单强调色。线条干净一笔画无多余装饰。背景必须极简无场景元素。保留核心轮廓和发色即可，细节可简化。English: minimalist cartoon style, clean lines, flat colors, geometric shapes, simple and cute, modern illustration",
};
function delay(ms) {
...
export const mockAvatarProvider = {
    ...
    async analyzePhotoWithModel(_imageBase64, model) {
        await delay(50 + Math.random() * 100);
 ...
 */
export function downloadMockImage(url, destPath) {
...
//# sourceMappingURL=mock-avatar.js.map